class Parser(object):
	...
	#simple add program
	#alist =[('TK_PROGRAM', 'program', 1, 7), ('TK_IDENTIFIER', 'Add', 1, 11), ('TK_SEMICOLON', ';', 1, 12), ('TK_VAR', 'var', 2, 3), ('TK_IDENTIFIER', 'a', 2, 5), ('TK_COMMA', ',', 2, 6), ('TK_IDENTIFIER', 'b', 2, 8), ('TK_COMMA', ',', 2, 9), ('TK_IDENTIFIER', 'c', 2, 10), ('TK_COLON', ':', 2, 12), ('TK_ID_INTEGER', 'integer', 2, 20), ('TK_SEMICOLON', ';', 2, 21), ('TK_BEGIN', 'begin', 3, 5), ('TK_IDENTIFIER', 'a', 4, 2), ('TK_ASSIGNMENT', ':=', 4, 5), ('TK_INTEGER', '2', 4, 7), ('TK_SEMICOLON', ';', 4, 8), ('TK_IDENTIFIER', 'b', 5, 2), ('TK_ASSIGNMENT', ':=', 5, 5), ('TK_INTEGER', '1', 5, 7), ('TK_SEMICOLON', ';', 5, 8), ('TK_IDENTIFIER', 'c', 6, 2), ('TK_ASSIGNMENT', ':=', 6, 5), ('TK_IDENTIFIER', 'a', 6, 7), ('TK_ADD', '+', 6, 8), ('TK_IDENTIFIER', 'b', 6, 11), ('TK_SEMICOLON', ';', 6, 12), ('TK_END_DOT', 'end.', 7, 4)]
	#repeat loop 
	...
	#alist = [('TK_PROGRAM', 'program', 1, 7), ('TK_IDENTIFIER', 'ifChecking', 1, 18), ('TK_SEMICOLON', ';', 1, 19), ('TK_VAR', 'var', 2, 3), ('TK_IDENTIFIER', 'a', 2, 4), ('TK_COLON', ':', 2, 6), ('TK_ID_INTEGER', 'integer', 2, 14), ('TK_SEMICOLON', ';', 2, 15), ('TK_BEGIN', 'begin', 3, 5), ('TK_IDENTIFIER', 'a', 4, 2), ('TK_ASSIGNMENT', ':=', 4, 5), ('TK_INTEGER', '2', 4, 7), ('TK_SEMICOLON', ';', 4, 8), ('TK_IF', 'if', 5, 3), ('TK_OPEN_PARENTHESIS', '(', 5, 5), ('TK_IDENTIFIER', 'a', 5, 7), ('TK_LESS', '<', 5, 9), ('TK_INTEGER', '20', 5, 12), ('TK_CLOSE_PARENTHESIS', ')', 5, 13), ('TK_THEN', 'then', 5, 18), ('TK_WRITELN', 'writeln', 6, 9), ('TK_OPEN_PARENTHESIS', '(', 6, 10), ('TK_STRING', "'hello'", 6, 17), ('TK_CLOSE_PARENTHESIS', ')', 6, 18), ('TK_ELSE', 'else', 7, 5), ('TK_WRITELN', 'writeln', 8, 9), ('TK_OPEN_PARENTHESIS', '(', 8, 10), ('TK_IDENTIFIER', 'a', 8, 11), ('TK_CLOSE_PARENTHESIS', ')', 8, 12), ('TK_END_DOT', 'end.', 9, 4)]
